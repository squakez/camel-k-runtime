...
@JsonDeserialize(builder = CamelTrait.Builder.class)
@JsonPropertyOrder({"groupId", "artifactId", "version"})
public interface CamelTrait {
    @Value.Auxiliary
    @Value.Default
    @Value.NaturalOrder
    ...
    static CamelTrait forArtifact(String groupId, String artifactId) {
        return new Builder().addDependency(groupId, artifactId).build();
    }

    class Builder extends ImmutableCamelTrait.Builder {
